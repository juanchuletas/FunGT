...
struct Quaternion {
    ...
    static Quaternion fromAxisAngle(const fungl::Vec3& axis, float angle) {
        float halfAngle = angle * 0.5f;
        float sinHalf = std::sin(halfAngle);
        fungl::Vec3 normalizedAxis = axis.normalize();
