...
struct Contact {
    ...
    fungt::Vec3 colissionPoint;
    fungt::Vec3 colissionNormal;  // Points from A to B
    float penetrationDepth;
    
    Contact(std::weak_ptr<RigidBody> a, std::weak_ptr<RigidBody> b, fungt::Vec3 point, fungt::Vec3 normal, float depth)
